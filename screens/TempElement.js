    ...
    return (
      <Block flex>
        ...
        <Block style={{ paddingHorizontal: theme.SIZES.BASE }}>
          ...
          <Block row style={{ alignItems: 'center',marginTop:10,backgroundColor:argonTheme.COLORS.INFO,borderRadius:5 }}>
          <Block style={{ flex: 1 ,marginRight:0}}>
            <Text color={argonTheme.COLORS.WHITE} style={{  padding: 10,borderRadius:8 ,alignItems:'center'}} numberOfLines={3}>
              Example Text ExampleText Example Text ExampleText ExampleText Example Text Example Text Example Text Example Text
          ...
          <Icon name="favorite"family="MaterialIcons " size={40} color={argonTheme.COLORS.GRADIENT_END} style={{marginRight:5,marginLeft:10,}}/>
